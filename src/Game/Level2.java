        ...
        sunTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                Platform.runLater(() ->{
                    ...
                    translateSun(sun, gridY[new Random().nextInt(3)+1]+30);
                });
            }
        },0,16*1000);
        ...
        zombieTimer.scheduleAtFixedRate(new TimerTask(){
            ...
            public void run(){
                Platform.runLater(() -> {
                    ...
                    zombieImage = zombie.ZombieImageLevel2();
