...
public class Level4 extends Thread {
    @FXML
    ...
    public ImageView wnCard;

    private int selectedPlant = -1;  //0: Peashooter, 1: Sunflower, 2: CherryBomb, 3: Walnut
    private int counter = 100;
    private int[] gridX = {275, 373, 463, 570, 664, 760, 860, 953, 1051, 1151};
    private int[] gridY = {107, 212, 332, 452, 566, 685};
    private String[] objectTypes = {"Peashooter", "Sunflower", "CherryBomb", "Walnut"};
